        ...
        <div class="row mt-3">
          ...
          <div class="col-2">
            <div class="form-group <?php echo form_error('duration_min') ? ' has-error' : ''; ?>">
              ...
              <span class="small form-error w-100"> <?php echo strip_tags(form_error('duration_min')); ?> </span>
              <div class="clearfix"></div>
              <span class="text-warning w-100"><?php echo lang('enter_zero_for_unlitimited_time'); ?></span>
            </div>
          </div>
          ...
          <div class="col-2">
            <div class="form-group togle_button attempt "> 
              <?php echo  form_label(lang('allow_number_of_attempt'), 'quiz_attempt'); ?>
