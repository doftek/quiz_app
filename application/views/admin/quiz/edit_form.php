...
<div class="row"> 
	...
	<div class="col-12 col-md-12 col-lg-12">
    	...
    	<div class="col-12">	
				...
				<div class="row mt-3">
		          ...
		          <div class="col-4">
		            <div class="form-group <?php echo form_error('user_id') ? ' has-error' : ''; ?>">
		              <?php echo  form_label('Author / Tutor', 'user_id'); ?>
          ...
          <?php 
              $populateData = $this->input->post('is_quiz_active') ? $this->input->post('is_quiz_active') : (isset($quiz_data['is_quiz_active']) ? $quiz_data['is_quiz_active'] : 0 );
          ...
          <div class="col-2">
            <div class="form-group <?php echo form_error('duration_min') ? ' has-error' : ''; ?>">
              ...
              <span class="required">*</span>
              <?php 
                $populateData = $this->input->post('duration_min') ? $this->input->post('duration_min') : (isset($quiz_data['duration_min']) ? $quiz_data['duration_min'] : 0 );
              ?>
          ...
          ?>
           ...
           <div class="col-3">
            <div class="form-group togle_button">
              <?php echo  form_label(lang('disable_previous_button_on_test_page'), 'is_previous_disable'); ?>
              <label class="custom-switch form-control">
              ...
              <span class="text-warning w-100"><?php echo lang('you_can_disable_previous_button_on_test_page'); ?></span>
				...
				<?php 
					...
					$populateData = $this->input->post('is_result_disable') == 1 ? 'checked' : (isset($quiz_data['is_disable_result']) && $quiz_data['is_disable_result'] == 1 ? 'checked' :  '' );
				?>   
				...
				<div class="col-2">
					<div class="form-group togle_button">
						...
						<label class="custom-switch form-control">
						<input type="checkbox" name="is_result_disable" value="1" <?php echo xss_clean($populateData); ?> class="custom-switch-input is_quiz_active"  data-size="sm">
						<span class="custom-switch-indicator"></span>
						</label>
					</div>
				</div>  
              ...
              <div class="col-2">
		          ...
		          <div class="col-2">
		              <div class="form-group <?php echo form_error('marks_for_correct_answer_err') ? ' has-error' : ''; ?>">
		                <?php echo  form_label(lang('marks_for_correct_answer'), 'marks_for_correct_answer'); ?> <span class="text-danger"> *</span>
		                <?php 
		          ...
		          <div class="col-2">
		            <div class="form-group togle_button attempt ">
		              <?php echo  form_label(lang('allow_number_of_attempt'), 'is_random'); ?>
		              <?php
		          ...
		          <div class="col-4">
		            <div class="form-group">
                		...
                		<?php 
		                  $helpsheet_img = (isset($quiz_data['quiz_helpsheet']) && $quiz_data['quiz_helpsheet']) ? base_url('assets/images/helpsheet/'.$quiz_data['quiz_helpsheet']) :  base_url('assets/default/default.jpg');
		                ?>
		                <img src='<?php echo $helpsheet_img; ?>' class="img_thumb mt-2 popup">
		                <?php if($quiz_data['quiz_helpsheet']) { ?>
		                 <a href="<?php echo base_url('admin/QuizController/delete_helpsheet/'.$quiz_data['id']); ?>" class="delete_attachment" data-quiz_id="<?php echo xss_clean($quiz_data['id'])?>">Delete Attachment</a>
		                <?php } ?> 
		          ...
		          <div class="col-2">
		            <div class="form-group togle_button">
		              ...
		              <label class="custom-switch form-control">
		              	<?php 
				            $populateData = $this->input->post('is_premium') == 1 ? 'checked' : (isset($quiz_data['is_premium']) && $quiz_data['is_premium'] == 1 ? 'checked' :  '' );
            	...
            	<div class="col-2">
	              <div class="form-group">
	                ...
	                $populateData = $this->input->post('evaluation_test') ? $this->input->post('evaluation_test') : (isset($quiz_data['evaluation_test']) ? $quiz_data['evaluation_test'] :  '' );
	                ?>
          ...
          <?php 
              $populateData = $this->input->post('hide_correct_answer') ? $this->input->post('hide_correct_answer') : (isset($quiz_data['hide_correct_answer']) ? $quiz_data['hide_correct_answer'] : 0);
          ...
          <div class="col-2">
            <div class="form-group togle_button">
              <?php echo  form_label(lang('hide_answers_on_result'), 'hide_correct_answer'); ?>
              <label class="custom-switch form-control">
                ...
                <span class="custom-switch-indicator"></span>
		          ...
		          <?php 
		              $populateData = $this->input->post('is_sheduled_test') ? $this->input->post('is_sheduled_test') : (isset($quiz_data['is_sheduled_test']) ? $quiz_data['is_sheduled_test'] : 0);
	          		...
	          		<div class="row">
				        ...
				        <div class="col-6">
				            <div class="form-group <?php echo form_error('start_date_time') ? ' has-error' : ''; ?>"> 
				              <?php echo  form_label(lang('Quiz Start Date Or Time'), 'quiz_attempt'); ?>
		            ...
		            <div class="form-group <?php echo form_error('featured_image[]') ? ' has-error' : ''; ?>">
		              ...
		              ?>
		                <div class="row product_uploded_image mt-3">
		                  <?php 
		                  if(isset($featured_image_array) && $featured_image_array) { 
		                  foreach ($featured_image_array as  $featured_image_name) { ?>
		                    <div class="col-1">
