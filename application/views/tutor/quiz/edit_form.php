...
<div class="row"> 
	...
	<div class="col-12 col-md-12 col-lg-12">
    	...
    	<hr>	
    	  ...
    	  <div class="col-md-12"><a href="<?php echo base_url('tutor/quiz/translate-quiz/').$quiz_id ?>" class="btn btn-warning float-right"><?php echo lang('translate_quiz_btn'); ?></a></div>
				...
				<div class="col-2">
		          ...
		          <div class="col-2">
                    ...
                    <select name="reward_percentage" class="form-control select2 reward_percentage" id="reward_percentage">
                      <option value="o"><?php echo lang('select_reward'); ?> %</option>
                      <?php 
                      for($i=1; $i <= 100; $i++)
                      {
                        $selected = $populateData == $i ? "selected" : "";
              ...
              <div class="col-2">
		          ...
		          <div class="col-2">
		            <div class="form-group togle_button attempt ">
		              <?php echo  form_label(lang('allow_number_of_attempt_on_quiz'), 'is_random'); ?>
		              <?php
